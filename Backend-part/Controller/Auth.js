...
module.exports.sign_up = async (req, res)=> {
    ...
    */
    ...
    if(data.username == 'delete' || data.username == 'message' || data.username == 'signin' || data.username == 'signup' || data.username == 'signout'){
        res.status(403).send({invalid: "\"username\" not valid"});
        return;
    }
    // data is valid
